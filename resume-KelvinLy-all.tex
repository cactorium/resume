...
\datedsubsection{\textbf{Guitar Club}, lessons coordinator}{Spring 2014}
    ...
    \end{itemize}
\datedsubsection{\textbf{Tau Beta Pi honors society, Florida Delta chapter}, webmaster}{Fall 2014 - Spring 2015}
    \begin{itemize}
        \item Coordinated induction of 50 members
    \end{itemize}
    \datedsubsection{\textbf{Eta Kappa Nu (HKN) honors society, Zeta Chi chapter}, corresponding secretary}{Spring 2015 - present}
    \begin{itemize}
